      ...
      <nav className="border-b border-gray-300 bg-white dark:bg-gray-800 dark:border-gray-700 font-semibold">
        <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
          ...
          <div className="hidden md:flex items-center gap-4 ml-auto">
            ...
            {role === "admin" ? (
                <div className="block py-2 px-3 text-black no-underline hover:bg-gray-100 rounded transition-all duration-200 transform hover:scale-105 active:scale-95" onClick={() => setManageUsersShow(true)}>
                  Manage Users
                </div>
            ) : (
              <>
